  ...
  return (
    <div style={containerStyle}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <h2 style={{ color: '#ffffff', background: 'transparent', margin: 0 }}>Manage Products</h2>
        <Link to="/admin/addproduct" className="btn">+ Add Product</Link>
      </div>
          ...
          <tbody>
            {products.map(product => (
              <tr key={product._id} style={rowStyle}>
                ...
                <td style={tdStyle}>
                  <Link to={`/admin/editproduct/${product._id}`} style={editBtn}>Edit</Link>
